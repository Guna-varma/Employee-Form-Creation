...
namespace Emp.DataAccess.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        public DbSet<DepatmentLocation> depatmentLocationList { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeDetails>().HasData(
                new EmployeeDetails { Id = 1, EmployeeCode = "22060023", FirstName = "Guna", LastName = "Varma",Gender = "Male" ,DepartmentId=1, ImageURL= ""}
                );
